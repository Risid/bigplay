...
# define MADPLAY_VERSION	"0.10.1 based on MadPlay 0.15.2 (beta)"

# define MADPLAY_PUBLISHYEAR	"2018-2019"
# define MADPLAY_AUTHOR		"Risid"
# define MADPLAY_EMAIL		"oossooss@163.com"
